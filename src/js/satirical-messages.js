// Satirical confirmation messages shown after a song request is submitted.
// Shared between request.js and E2E tests — single source of truth.

export const SATIRICAL_MESSAGES = [
...
export const ALREADY_REQUESTED = [
  ...
  "Din giriga fitta! Du har ju redan önskat... jävla borgare!",
];
